...
export default async function AdminUsersPage() {
  ...
  const data = res instanceof Response ? await res.json() : (res as any);
    ...
    <main className="mx-auto max-w-5xl px-4 py-10">
      ...
      <section className="mt-6 rounded-md border border-black/10 p-4 dark:border-white/15">
        ...
        <form action={createUserAction} className="mt-3 grid gap-3 sm:grid-cols-4">
          ...
          <button
            type="submit"
            className="sm:col-span-4 rounded-md bg-black px-3 py-2 text-sm text-white dark:bg-white dark:text-black"
          >
            Create
          </button>
        </form>
